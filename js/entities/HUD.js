...
game.HUD.ScoreItem = me.Renderable.extend({
    ...
    init: function(x, y) {
        ...
        this.font.tint = new me.Color(255, 128, 128);
    ...
    init: function(x, y, settings) {
        ...
        StateManager.on('lastWord', w => {
            ...
            if(!act) {
               ...
               game.data.score += parseInt(Constants.SCORES.CORRECT_WORD)
           }
        })
    }
})
...
game.HUD.ActionWords = me.Renderable.extend({
    init: function(x, y) {
        ...
        KeyboardControl.active(this.actionMapping)

        var screen = document.getElementById("screen").childNodes
        screen[0].style.height = "60vh"
        screen[0].style.width = "60vw"
    },
